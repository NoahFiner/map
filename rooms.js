...
$(document).ready(function() {
  ...
  floors[6][35] = new Room (6, 73, 32, '646', 'Classroom/office????'); //TODO: wtf is this thing
  floors[6][36] = new Room (6, 80, 31, '647', 'Social studies classroom');
  floors[6][37] = new Room (6, 82, 29, '648', 'Social studies classroom');
  ...
  floors[6][42] = new Room (6, 74, 37, '604', ''); //TODO: is this storage or something
  floors[6][43] = new Room (6, 83, 35, '602', 'Social studies classroom');
  floors[6][44] = new Room (6, 86, 32, '601', 'Social studies classroom');
